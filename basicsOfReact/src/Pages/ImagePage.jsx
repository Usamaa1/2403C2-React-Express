...
import firstImage from '../images/doncoombez-IJ6i3JOkgLY-unsplash (1).jpg'
    ...
    return (
        <div>
            ...
            <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
                <a href="#">
                    <img className="rounded-t-base" src={firstImage} alt="" />
                    {/* <img className="rounded-t-base" src="/public/nik-iurev-AAWW9uFQ1hY-unsplash (1).jpg" alt="" /> */}
                </a>
